...
<template>
    <!-- list测试 -->
    <kl-list :dataSource="data" size="small">
    ...
    <!-- <kl-list :dataSource="data" size="normal">
        <kl-list-item>normal</kl-list-item>
    </kl-list>

    <kl-list :dataSource="data" size="large">
        <kl-list-item>large</kl-list-item>
    </kl-list> -->
    <div>
        <h2>基础按钮</h2>
